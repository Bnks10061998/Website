...
//     e.preventDefault();
//     // For now just alert. You can connect to backend or email service here.
...
//   return (
//     <motion.section
//       className="max-w-3xl mx-auto px-8 py-20 mt-16 rounded-3xl shadow-2xl bg-gradient-to-r from-indigo-50 via-white to-indigo-50"
